...
const registerFirmaLifeRecipes = (event) => {
    ...
    // Kurama Adjusted - re enabled this block to be craftable, otherwise you couldnt properly use the sprinkler system of firmalifes greenhouses, you can still pump water into the pumping station via create
    ...
    // Kura Adjustments - Added back a recipe For it

    event.remove({ output: 'firmalife:pumping_station' })
    ...
    }).id('firmalife:crafting/pumping_station')
