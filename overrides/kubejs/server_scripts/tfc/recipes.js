...
const registerTFCRecipes = (event) => {
    ...
    global.TFC_STONE_TYPES.forEach(stone => {
        ...
        // Камни -> Булыжник - Kurama Adjusted - disabled this since i added back the original compress recipe below do 4 loose stones to 1 cobble via character crafting window
        ...
        //    B: '#tfc:mortar'
        //}).id(`tfc:crafting/rock/${stone}_loose_rocks_to_cobble_with_mortar`)

        // Kurama Adjusted - Added back the original loose to cobble recipe, otherwise your inventorys fill up to fast and you need to make billions of mortar
        event.shaped(`tfc:rock/cobble/${stone}`, [
            'AA',
            'AA' 
        ], {
        ...
        event.recipes.gtceu.assembler(`${stone}_loose_rocks_to_cobble`)             
            ...
            .circuit(0)
            .inputFluids(Fluid.of('gtceu:concrete', 72))
            .itemOutputs(`2x tfc:rock/cobble/${stone}`)
            .duration(50)
            .EUt(2)
        ...
        event.shaped(`2x tfc:rock/mossy_cobble/${stone}`, [
            'ABA',
            'BAB',
            'ABA'  
        ], {
        ...
        event.recipes.gtceu.assembler(`${stone}_mossy_loose_rocks_to_mossy_cobble`)             
            ...
            .circuit(0)
            .inputFluids(Fluid.of('gtceu:concrete', 72))
            .itemOutputs(`2x tfc:rock/mossy_cobble/${stone}`)
            .duration(50)
            .EUt(2)
